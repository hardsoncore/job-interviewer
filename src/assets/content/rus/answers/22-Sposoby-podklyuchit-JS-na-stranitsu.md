...
<h3>Порядок подключения скриптов и на что он влияет</h3>

<p>
  Скрипты можно подключать в <code>&lt;head&gt;</code> или в конце <code>&lt;body&gt;</code>. Разница в том, когда они загружаются и выполняются.
</p>
<p>
  Если скрипт в <code>&lt;head&gt;</code>, он блокирует рендеринг страницы до загрузки и выполнения. Если в конце <code>&lt;body&gt;</code>, страница сначала загружается, а скрипт выполняется после.
</p>
