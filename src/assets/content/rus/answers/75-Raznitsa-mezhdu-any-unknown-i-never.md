...
<p>
  <span class="accent">Когда использовать:</span> <b>Практически никогда в новом коде.</b> Это допустимо лишь при постепенной миграции крупного легаси-проекта на TypeScript или для очень быстрых и временных хаков при отладке.
</p>
...
<p>
  <span class="accent">Поведение:</span> Переменной типа never нельзя присвоить ничего (даже any).
</p>
