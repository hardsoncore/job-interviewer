...
<p class="info info--orange">
  <strong>Observables</strong> ленивые/холодные, потому что они не делают ничего, пока на них не подпишутся. И они эгоистичные, потому что каждый подписчик получает свой собственный независимый поток данных.
</p>
...
<p class="info info--orange">
  <strong>Subjects</strong> активные/горячие, потому что они начинают вещать сразу после вызова <code>.next()</code>, независимо от того, есть ли подписчики. И они коллективные, потому что все подписчики получают одно и то же значение одновременно.
</p>
