...
<p>
  <span class="accent">Коли використовувати:</span> <b>Практично ніколи в новому коді.</b> Це допустимо лише на етапі додавання нової функціональності або виправлення багів - поки рішення ще не до кінця готове і ДО пушу коду в віддалений репозиторій. Або ж під час поступової міграції великого легасі-проєкту на TypeScript.
</p>
...
<p>
  <span class="accent">Поведінка:</span> Змінній типу <code>never</code> не можна присвоїти нічого (навіть <code>any</code>).
</p>
