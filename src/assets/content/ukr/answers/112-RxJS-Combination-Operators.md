...
<p>
  <strong>WithLatestFrom</strong> схожий на combineLatest, але тут є явний "лідер". Видає значення тільки тоді, коли емітить головний (source) потік. Інші потоки просто "підмішують" свої останні актуальні стани.
  <br>
